...
#zip_df
# Following code requires dplyr library for case_when -> 
#zip_df <- 
  #ddply(zip_df,.(zip5),mutate,
        #ctyname = case_when(is.na(ctyname)&zip5==98052 ~ "REDMOND", TRUE~ctyname))
zip_df <-
  ddply(zip_df, .(zip5), mutate,
      ctyname=ifelse(is.na(ctyname)&zip5==98052,"REDMOND",ctyname))
